...
print('2:', re.fullmatch(r'ab{2,3}', 'ab') is not None)
print('3:', re.findall(r'[a-z]+_[a-z]+', 'hello_world test case'))
print('4:', re.findall(r'[A-Z][a-z]+', 'Apple Banana ghh'))
print('5:', re.fullmatch(r'a.*b', 'axxxbc') is not None)
